    ...
    (0, _createClass3.default)(PreviewHelper, [{
        ...
        value: function componentWillMount() {
            ...
            if (this.props.preview.isReactNative) {
                this.componentInfo.props.gaeaNativeEventData && this.componentInfo.props.gaeaNativeEventData.forEach(function (data) {
                    if (data.typeIndex === -1 && data.type === 'init') {
                        _this2.runEvent(data);
                    }
                });
            } else {
                this.componentInfo.props.gaeaEventData && this.componentInfo.props.gaeaEventData.forEach(function (data) {
                    if (data.typeIndex === -1 && data.type === 'init') {
                        _this2.runEvent(data);
                    }
                });
        ...
        value: function runEvent(eventData) {
            var event = this.componentInfo.props.gaeaEvent.events[eventData.eventIndex];
        ...
        value: function render() {
            ...
            if (this.componentInfo.props.gaeaUniqueKey === 'gaea-layout' && this.componentInfo.layoutChilds) {
                childs = this.componentInfo.layoutChilds.map(function (layoutChildUniqueMapKey) {
                    return React.createElement(PreviewHelper, { key: layoutChildUniqueMapKey, preview: _this4.props.preview, mapUniqueKey: layoutChildUniqueMapKey });
                });
            }
            ...
            if (this.props.preview.isReactNative) {
                this.componentInfo.props.gaeaNativeEventData && this.componentInfo.props.gaeaNativeEventData.forEach(function (data) {
                    if (data.typeIndex > -1 && _this4.componentInfo.props.gaeaEvent.types[data.typeIndex].selfCallback) {
                        props[data.type] = _this4.runEvent.bind(_this4, data);
                    }
                });
            } else {
                this.componentInfo.props.gaeaEventData && this.componentInfo.props.gaeaEventData.forEach(function (data) {
