...
var PreviewHelper = function (_React$Component) {
    ...
    (0, _createClass3.default)(PreviewHelper, [{
        ...
        value: function render() {
            ...
            props.gaeaVariables && Object.keys(props.gaeaVariables).forEach(function (key) {
                var variable = props.gaeaVariables[key];
                var myParser = parser(variable.valueType);
                switch (variable.variableType) {
                    case 'externalParameter':
                        props[variable.field] = _this5.props.preview.params[variable.variableField] ? myParser(_this5.props.preview.params[variable.variableField]) : null;
                        break;
                }
            });
